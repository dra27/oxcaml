...
let linkage_name_of_cu comp_unit =
  Compilation_unit.mangle_for_linkage_name ~pack_separator:Symbol.pack_separator comp_unit
        ...
        then None
          ...
          Some
            { dynu_name = info.ui_unit;
              dynu_crc = crc;
              dynu_defines = List.map linkage_name_of_cu info.ui_defines;
              dynu_imports_cmi =
        ...
        List.fold_right
          (fun info reqd ->
            ...
            then (
              ...
              in
              let quoted_globals =
                imports_list Fun.id infos.lib_quoted_globals info.li_quoted_globals
              in
                ...
                then None
                  ...
                  Some
                    { dynu_name = info.li_name;
                      ...
                      dynu_defines = List.map linkage_name_of_cu info.li_defines;
                      dynu_imports_cmi =
                        imports_list (Option.map dynu_import_cmi_of_ui_import_cmi)
                                     infos.lib_imports_cmi info.li_imports_cmi
                        |> Array.of_list;
                      dynu_imports_cmx =
                        imports_list (Option.map dynu_import_cmx_of_ui_import_cmx)

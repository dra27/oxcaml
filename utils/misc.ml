...
exception Fatal_error = Misc0.Fatal_error

let fatal_errorf = Misc0.fatal_errorf
let fatal_error = Misc0.fatal_error

let fatal_errorf_doc = Misc0.fatal_errorf_doc
